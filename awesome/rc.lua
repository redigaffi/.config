...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.spawn.with_shell("rofi -show run -theme solarized -show-icons") end,
    ...
    awful.key({ modkey }, "p", function() awful.spawn.with_shell("rofi -combi-modi window,drun -theme solarized -show combi -show-icons") end,
              {description = "show the menubar", group = "launcher"}),
        ...
        {description = "Launch gnome settings", group = "util"})
)
